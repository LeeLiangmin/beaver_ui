  ...
  return (
    <div className="max-w-2xl mx-auto py-2">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 mb-4">
        ...
        <div className="mb-3">
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-light focus:border-primary disabled:opacity-40 transition-colors"
          />
        ...
        <div className="mb-3">
          ...
          <div className="relative">
            <input
              ...
              placeholder="sk-..."
              disabled={!settings.aiEnabled}
              className="w-full border border-gray-300 rounded-lg px-3 py-2 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-primary-light focus:border-primary disabled:opacity-40 transition-colors"
            />
            <button
        ...
        <div className="mb-3">
          ...
          <input
            ...
            className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-light focus:border-primary disabled:opacity-40 transition-colors"
          />
          <p className="text-[10px] text-gray-400 mt-1">留空则直连；填写代理地址（含 http://）走代理</p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg bg-primary-light text-primary hover:bg-primary/20 disabled:opacity-30 transition-colors"
          >
      ...
      <div className="flex justify-end">
        <button
          onClick={save}
          className="flex items-center gap-1.5 px-4 py-2 bg-primary text-white rounded-lg text-sm hover:bg-primary-hover shadow-sm transition-colors"
        >
          <Save size={14} />
          保存设置
        </button>
